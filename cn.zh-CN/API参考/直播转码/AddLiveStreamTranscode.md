# AddLiveStreamTranscode {#concept_45039_zh .concept}
...
```
https://live.aliyuncs.com/?Action=AddLiveStreamTranscode&Domain=live.aliyunlive.com&App=xxx&Template=ld&<公共请求参数> 
```
