# DeleteLiveSnapshotDetectPornConfig {#reference1029 .reference}
...
```
 https://live.aliyuncs.com/?Action=DeleteLiveSnapshotDetectPornConfig&DomainName=live.aliyunlive.com&AppName=xxx<公共请求参数>
```
...
## 错误码 {#section_ecp_qkh_dfb .section}
