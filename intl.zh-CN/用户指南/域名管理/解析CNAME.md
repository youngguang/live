...
3.  选择所需的播流域名，并获取域名对应的CNAME。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/20690/153914358711550_zh-CN.png)
...
4.  复制CNAME地址，进行域名解析。
    ...
    3.  选择需要配置解析的域名，并单击 **解析**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/20690/153914358711551_zh-CN.png)

    4.  单击 **添加记录**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/20690/153914358711552_zh-CN.png)

    5.  设置解析参数，并单击 **确定**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/20690/153914358711553_zh-CN.png)
